...
export default function Footer() {
  return (
    <Container>
      ...
      <Right>
        <Title>Contact</Title>
        <ContactItem> <Room style={{marginRight:"10px"}}/> P.O Box 43998 00100. Nairobi, Kenya.</ContactItem>
        <ContactItem> <Phone style={{marginRight:"10px"}}/> +254700146711</ContactItem>
        <ContactItem> <MailOutline style={{marginRight:"10px"}}/> vkiplangat553@gmail.com</ContactItem>
